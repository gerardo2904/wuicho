...
function Footer()
{
	...
	$pdf->AddPage();
	$pdf->Ln(20);
	$str=iconv('UTF-8', 'windows-1252',"SEGUNDA.- El vendedor en este acto, exhibe al comprador la documentación en copia simple que ampara");
	$pdf->Cell(161,3,$str,0,0,"FJ");
	$pdf->Ln(5);
	...
	$pdf->SetLeftMargin(20);
	$pdf->Ln(8);	
	$str=iconv('UTF-8', 'windows-1252',"TERCERA.- El precio de la compraventa lo han determinado de común acuerdo el vendedor y el comprador");
		$pdf->Cell(161,3,$str,0,0,"FJ");
	$pdf->Ln(4);
...
Cada uno, que vencerán con la siguiente periodicidad ______________________ y en forma sucesiva los dias _____________ a partir del dia ________________________________________
");
	$pdf->MultiCell(164,4,$texto,0,'J');	
	$pdf->Ln(4);	
	$texto="";
