...
$variable="referencias_aval.clave_aval=avales.clave_aval";
...
if (strlen($recordID5) <> 0) 
	$variable .=" AND nombre_aval LIKE '%$recordID5%' ";
	

funciones_reemplazadas();

mysqli_select_db($contratos_londres, $database_contratos_londres);
$query_referencias = 'SELECT referencias_aval.clave_referencia, referencias_aval.clave_aval, referencias_aval.nombre_referencia, referencias_aval.rfc_referencia, referencias_aval.domicilio_referencia, referencias_aval.ciudad_referencia, referencias_aval.cp_referencia, referencias_aval.tel_referencia, referencias_aval.fax_referencia, referencias_aval.email_referencia, avales.nombre_aval FROM referencias_aval, avales WHERE '.$variable.' ORDER BY clave_aval, nombre_referencia ASC';
...
<title>Referencias Avales</title>
...
<p><strong>Referencias Avales.</strong></p>
...
<table border="1">
  <tr>
    ...
    <td width="129" nowrap="nowrap" bgcolor="#000066" class="style6">Nombre Aval</td>
  </tr>
  <?php do { ?>
    <tr>
      <td class="Texto_tabla"><a href="referencias_aval_edit.php?parametro1=<?php echo $row_referencias['clave_aval']; ?>&amp;parametro2=<?php echo $row_referencias['clave_referencia']; ?>" class="style4"><?php echo $row_referencias['nombre_referencia']; ?></a></td>
      ...
      <td class="style4"><a href="avales_edit.php?parametro1=<?php echo $row_referencias['clave_aval']; ?>"><?php echo $row_referencias['nombre_aval']; ?></a></td>
    </tr>
