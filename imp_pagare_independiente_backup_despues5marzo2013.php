...
//$str=iconv("UTF-8", "windows-1252","***".strtoupper($importe_texto)."***");
	...
	$pdf->SetFont('Arial','',8); 
	$pdf->Ln(7);
	$texto="Valor recibido a mi (nuestra) entera satisfacción.  Este PAGARE forma parte de una serie numerada del 1 al ".$row_contra['numero_pagares']." y todos estan sujetos a la condición de que, al no pagarse cualquiera de ellos a su vencimiento, seran exigibles todos los que le sigan en numeros, ademas de los ya vencidos desde la fecha de vencimiento hasta el dia de su liquidación, causara intereses moratorios del 5 % mensual, pagadero en esta ciudad y justamente con el principal.";
