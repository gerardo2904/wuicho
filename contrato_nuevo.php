<?php //virtual('/contratos_londres/Connections/contratos_londres.php'); ?>
...
$contratos = mysqli_query($contratos_londres, $query_contratos) or die(mysql_error());
...
$clientes = mysqli_query($contratos_londres, $query_clientes) or die(mysql_error());
...
$autos = mysqli_query($contratos_londres, $query_autos) or die(mysql_error());
$row_autos = mysqli_fetch_assoc($autos);
$totalRows_autos = mysqli_num_rows($autos);
...
$autos_acambio = mysqli_query($contratos_londres, $query_autos_acambio) or die(mysql_error());
$row_autos_acambio = mysqli_fetch_assoc($autos_acambio);
$totalRows_autos_acambio = mysqli_num_rows($autos_acambio);
...
$avales = mysqli_query($contratos_londres, $query_avales) or die(mysql_error());
...
$referencias = mysqli_query($contratos_londres, $query_referencias) or die(mysql_error());
...
$vendedor = mysqli_query($contratos_londres, $query_vendedor) or die(mysql_error());
...
$cobrador = mysqli_query($contratos_londres, $query_cobrador) or die(mysql_error());
...
$testigo = mysqli_query($contratos_londres, $query_testigo) or die(mysql_error());
...
$empresa = mysqli_query($contratos_londres, $query_empresa) or die(mysql_error());
...
$autos_datos = mysqli_query($contratos_londres, $query_autos_datos) or die(mysql_error());
$row_autos_datos = mysqli_fetch_assoc($autos_datos);
$totalRows_autos_datos = mysqli_num_rows($autos_datos);
...
$autos_acambio_datos = mysqli_query($contratos_londres, $query_autos_acambio_datos) or die(mysql_error());
$row_autos_acambio_datos = mysqli_fetch_assoc($autos_acambio_datos);
$totalRows_autos_acambio_datos = mysqli_num_rows($autos_acambio_datos);

$var="";
if ($recordID3<>0) { $var=" where clave_cliente='$recordID3'";} else { $var=" where clave_cliente=0";}
mysqli_select_db($contratos_londres, $database_contratos_londres);
$query_cliente_datos = "select * from clientes".$var;
$cliente_datos = mysqli_query($contratos_londres, $query_cliente_datos) or die(mysql_error());
...
$vendedor_datos = mysqli_query($contratos_londres, $query_vendedor_datos) or die(mysql_error());
...
$cobrador_datos = mysqli_query($contratos_londres, $query_cobrador_datos) or die(mysql_error());
$row_cobrador_datos = mysqli_fetch_assoc($cobrador_datos);
$totalRows_cobrador_datos = mysqli_num_rows($cobrador_datos);
...
$testigo_datos = mysqli_query($contratos_londres, $query_testigo_datos) or die(mysql_error());
$row_testigo_datos = mysqli_fetch_assoc($testigo_datos);
$totalRows_testigo_datos = mysqli_num_rows($testigo_datos);
...
$verifica = mysqli_query($contratos_londres, $query_verifica) or die(mysql_error());
...
$verifica2 = mysqli_query($contratos_londres, $query_verifica2) or die(mysql_error());
$row_verifica2 = mysqli_fetch_assoc($verifica2);
$totalRows_verifica2 = mysqli_num_rows($verifica2);

mysqli_select_db($contratos_londres, $database_contratos_londres);
$query_monedas = "select * from monedas";
$monedas = mysqli_query($contratos_londres, $query_monedas) or die(mysql_error());
...
<input name="aspecto_car" type="text" class="style3" id="aspecto_car" value="<?php echo $_GET['aspecto_car'];  ?>" size="15" />
      ...
      <input name="otros_aspectos" type="text" class="style3" id="otros_aspectos" value="<?php echo $_GET['otros_aspectos'];  ?>" size="20" />
...
actualiza_total(this);" value="<?php  echo $_GET['interes'];  ?>" size="5" <?php if ($recordID12==2 ) {echo "disabled";} else {echo "enabled";}?>/></td>
    ...
    <tr>
      ...
      <td><label>
      <select name="clave_moneda" class="style18" id="clave_moneda">
        <?php
do {  
?>
        <option value="<?php echo $row_monedas['clave_moneda']?>"<?php if (!(strcmp($row_monedas['clave_moneda'], $_GET['clave_moneda']))) {echo "selected=\"selected\"";} ?>><?php echo $row_monedas['moneda']?></option>
        <?php
} while ($row_monedas = mysql_fetch_assoc($monedas));
  $rows = mysql_num_rows($monedas);
  if($rows > 0) {
      mysql_data_seek($monedas, 0);
	  $row_monedas = mysql_fetch_assoc($monedas);
  }
?>
      </select>
      </label></td>
