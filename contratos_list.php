...
/*if ($recordID5 == '1') 
	$variable .=" AND aplicado=1 ";
*/

if ($recordID5 == "Ambos") 
	$variable .=" ";
if ($recordID5 == "Aplicados") 
	$variable .=" AND aplicado=1 ";
if ($recordID5 == "No_aplicados") 
	$variable .=" AND aplicado=0 ";
...
$query_clientes = 'SELECT clientes.clave_cliente, clientes.nombre_cliente, clientes.domicilio_cliente, clientes.ciudad_cliente, contrato.clave_contrato, contrato.contrato, DATE_FORMAT(contrato.fecha_contrato, \'%d-%m-%Y\') as fecha, contrato.fecha_contrato, aplicado, if(aplicado=1,"Sí","No") as aplicadot FROM clientes, contrato WHERE '.$variable.' ORDER BY fecha DESC';
...
<p><strong>Ordenes de trabajo.</strong></p>
<form id="form1" name="form1" method="get" action="contratos_list.php">
  <table width="958" border="1">
    <tr>
      <td width="152" bgcolor="#000033" class="style6"><div align="center">Orden</div></td>
      <td width="149" bgcolor="#000033" class="style6"><div align="center">Cliente</div></td>
      <td width="160" bgcolor="#000033" class="style6"><div align="center">Domicilio</div></td>
      <td width="131" bgcolor="#000033" class="style6"><div align="center">Ciudad</div></td>
      <td width="247" bgcolor="#000033" class="style6"><div align="center">¿Aplicado?</div></td>
      <td width="79" bgcolor="#000033" class="style6">&nbsp;</td>
    </tr>
    <tr>
      <td><div align="center">
      ...
      <td><div align="right"><span class="style7">Ambos</span>
        <input  <?php if (!(strcmp($_GET['aplicado'],"Ambos"))) {echo "checked=\"checked\"";} ?> name="aplicado" type="radio" value="Ambos" checked="checked" />
        <span class="style7">Aplicados</span>
        <input  <?php if (!(strcmp($_GET['aplicado'],"Aplicados"))) {echo "checked=\"checked\"";} ?> name="aplicado" type="radio"  value="Aplicados" />
        <span class="style7">No Aplicados</span>
        <input  <?php if (!(strcmp($_GET['aplicado'],"No_aplicados"))) {echo "checked=\"checked\"";} ?> name="aplicado" type="radio"  value="No_aplicados" />        
      </div><label for="aplicado"></label></td>
...
<table border="1">
  <tr>
    ...
    <td bgcolor="#000066" class="style1 Encabezado_tabla"><span class="style6">Orden</span></td>
