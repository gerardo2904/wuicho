...
$emp2 = mysql_query($query_emp2, $contratos_londres) or die(mysql_error());
$row_emp2 = mysql_fetch_assoc($emp2);
$totalRows_emp2 = mysql_num_rows($emp2);
...
?>
            ...
            <?php
} while ($row_emp2 = mysql_fetch_assoc($emp2));
  $rows = mysql_num_rows($emp2);
  if($rows > 0) {
      mysql_data_seek($emp2, 0);
	  $row_emp2 = mysql_fetch_assoc($emp2);
  }
?>
            </select>
